...
class MaskedInput extends \yii\widgets\InputWidget
{
    ...
    public function run()
    {
		...
		Html::addCssClass($this->options, "masked");
		$this->options['pattern'] = '\d{2}:\d{2}';
 		return Html::input("tel", null, $this->value, $this->options);
    }
...
JS;
		$view->registerJs($common_js, \yii\web\View::POS_READY, 'santilin_masked_input' );
	}
