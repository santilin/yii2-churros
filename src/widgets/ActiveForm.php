	...
	public const FORM_FIELD_HORIZ_CLASSES = [
		...
		'2cols' => [
			...
			'medium' => [
				'horizontalCssClasses' => [
					'offset' => 'offset-md-2 offset-sm-3',
					'label' => [ 'col-form-label col-lg-6 col-12', 'text-start text-md-end'],
					'wrapper' => ['col-lg-6 col-12'],
					'error' => '',
					'hint' => '',
					'field' => 'form-group',
				]
		...
		'3cols' => [
			...
			'checkbox' => [
				'horizontalCssClasses' => [
					'offset' => 'offset-md-2 offset-sm-3',
					'label' => [ 'col-lg-3 col-md-4 col-6', 'form-check-label text-start text-md-end'],
					'wrapper' => ['col-lg-3 col-md-4 col-6'],
					'error' => '',
					'hint' => '',
					'field' => 'form-group',
