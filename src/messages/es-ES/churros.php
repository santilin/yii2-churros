...
return [
    ...
    '{La} {title} <a href="{model_link}">{record_short}</a> has been successfully created.' => '{La} {title} <a href="{model_link}">{record_short}</a> se ha creado correctamente.',
    '{La} {title} <strong>{record_short}</strong> has been successfully deleted.' => '{La} {title} <strong>{record_short}</strong> se ha borrado correctamente.',
    '{La} {title} <a href="{model_link}">{record_short}</a> has been successfully duplicated.' => '{La} {title} <a href="{model_link}">{record_short}</a> se ha duplicado correctamente.',
    '{La} {title} <a href="{model_link}">{record_short}</a> has been successfully updated.' => '{La} {title} <a href="{model_link}">{record_short}</a> se ha actualizado correctamente.',
    ...
    'Error deleting {la} {title} {record_short}' => 'Error borrando {la} {title} {record_short}',
    "{La} {title} <strong>{record_short}</strong> can't be deleted because it has related data" => "No se puede borrar {la} {title} <strong>{record_short}</strong>  porque está en uso en otros ficheros",
];
