...
return [
    ...
    '{La} {title} <a href="{model_link}">{record}</a> has been successfully created.' => '{La} {title} <a href="{model_link}">{record}</a> se ha creado correctamente.',
    '{La} {title} <strong>{record}</strong> has been successfully deleted.' => '{La} {title} <strong>{record}</strong> se ha borrado correctamente.',
    '{La} {title} <a href="{model_link}">{record}</a> has been successfully duplicated.' => '{La} {title} <a href="{model_link}">{record}</a> se ha duplicado correctamente.',
    '{La} {title} <a href="{model_link}">{record}</a> has been successfully updated.' => '{La} {title} <a href="{model_link}">{record}</a> se ha actualizado correctamente.',
